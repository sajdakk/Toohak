          ...
          child: Center(
            child: Column(
              ...
              children: [
                ...
                if (widget.event.finalPosition != null)
                  Column(
                    children: [
                      Text(
                ...
                const SizedBox(height: 24.0),
                Text(
                  'Procentowa wartość poprawnie udzielonych odpowiedzi: ${widget.event.questionsAnsweredCorrectly / widget.state.gameTemplate.questions.length * 100}% }',
                  style: ThTextStyles.headlineH1Bold.copyWith(
                    color: ThColors.textText1,
                  ),
                  textAlign: TextAlign.center,
                ...
                const SizedBox(height: 24.0),
                Text(
                  'Średni czas odpowiedzi: ${widget.event.awarageAnswerTimeInMilis / 1000} sekund}',
                  style: ThTextStyles.headlineH1Bold.copyWith(
                    color: ThColors.textText1,
                  ),
                  textAlign: TextAlign.center,
