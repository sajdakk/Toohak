...
class NonUniformBorder extends InputBorder {
  ...
  @override
  NonUniformBorder copyWith({BorderSide? borderSide}) => NonUniformBorder(
        leftWidth: borderSide?.width ?? leftWidth,
        topWidth: borderSide?.width ?? leftWidth,
        rightWidth: borderSide?.width ?? leftWidth,
        bottomWidth: borderSide?.width ?? leftWidth,
        color: borderSide?.color ?? color,
        strokeAlign: borderSide?.strokeAlign ?? strokeAlign,
  ...
  static NonUniformBorder? lerp(NonUniformBorder? a, NonUniformBorder? b, double t) {
    if (a == null && b == null) {
      return null;
    }
    if (a == null) {
  ...
  @override
  int get hashCode => Object.hash(color, strokeAlign, borderRadius, topWidth, rightWidth, bottomWidth, leftWidth);
...
extension _RRectInflation on EdgeInsets {
  ...
  RRect inflateRRect(RRect rect) {
    return RRect.fromLTRBAndCorners(
      ...
      bottomRight: positiveRadius(rect.brRadius + Radius.elliptical(right, bottom)),
      bottomLeft: positiveRadius(rect.blRadius + Radius.elliptical(left, bottom)),
    );
  }
